...
<div id="tabs">
	...
	<div id="tab_<?php echo $store->id;?>">
		...
		<tr>
			...
			$urlLotList = Forms::getLink(FORM_LOT_LIST, array("item" => $item->id, "store" => $store->id));
			?>
			...
			<td class="date"><a href="<?php echo $urlLotList;?>">Ver Lotes</a><br/><a href="<?php echo $urlLotNew;?>">Nuevo Lote</a></td>    
