...
function listOrder( value ) {
	document.adminForm.order.value = value;
	document.adminForm.flag_order.value = "1";
	try {
...
{
  var frm = document.adminForm ? document.adminForm : $('adminForm');
	frm.hidemainmenu.value=1;
}

function showMainMenu()
{
  var frm = document.adminForm ? document.adminForm : $('adminForm');
	frm.hidemainmenu.value=0;
}
